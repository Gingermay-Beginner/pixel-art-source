...
SKY     = (198, 230, 248)
SKY_TOP = (178, 215, 238)
SKY_HZ  = (222, 238, 248)   # horizon glow
...
# ── Rainbow ──
RB_RAW = [(228,178,115),(228,218,135),(148,205,148),(125,185,222),(148,138,205)]
SKY_C = (185, 218, 242)
_fade_start_x = 0
...
for _bi, _rc in enumerate(RB_RAW):
    ...
    for _x in range(0, 64):
        for _y in range(0, 27):
            _dist = math.sqrt(((_x - 32))**2 + (_y - 25)**2)
            if _r1 <= _dist < _r2:
...
# 波浪轮廓：每列云顶 y（波峰波谷交替）
_cld_top = {
     0:15,  1:15,  2:15,  3:14,  4:14,  5:14,  6:15,  7:15,
     8:15,  9:14, 10:13, 11:13, 12:13, 13:13, 14:14, 15:14,
