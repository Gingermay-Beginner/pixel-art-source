...
- **正式文章**：标题下方第一行有日期（如 `金渐成2026年4月25日 20:16`）→ 用原文标题，正文从第一段写起，**末尾不加日期**
- **唠嗑/随笔**：无标题、无日期行 → 第一段作为飞书文档标题，正文从第二段开始写入，**末尾加日期**
- ⚠️ 只要看到标题下有日期，就一定是正式文章，绝对不是唠嗑类

## 完整入库步骤

1. **飞书文档**
   - 如果 May 发来了自己创建的文档链接 → 直接用，不要新建，May 会给编辑权限
   - 如果 May 只发来正文/wiki 链接没有文档 → 新建文档（folder: `XScsf4W4El3GX9dbbIzcRPKBnKe`），再授权 May full_access
...
5. **天玑汇总新建行**
   ...
   - 字段：
     ...
     - `作者标签`：**不要自己添加**，必须 May 明确告知才填；必须从现有选项中选（历史文章/美元资产/日常随笔/投资心得/唠唠嗑/地产透视），不新建；不确定时问 May；May 没回复则留空
     - ⚠️ 「金渐成/生玑伯伯/天机奇谈」是**公众号来源**，不是作者标签，不要填到作者标签里
     - `自己标签`：从现有选项中选
     - `星级`：**不要填，May 自己打**
