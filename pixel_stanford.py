...
SKY_B  = (138, 195, 232)   # 天空下（同上）
GROUND = (212, 192, 182)   # 地面（石板）
BENCH   = (218, 222, 228)   # 石椅中色
BENCH_L = (235, 238, 245)   # 石椅亮色（椅面）
BENCH_D = (198, 202, 210)   # 石椅暗色（椅下）
LEAF    = ( 78, 138,  98)   # 大树叶主绿
LLEAF   = (108, 138,  62)   # 左侧树叶暖绿
LLEAF_L = (115, 145,  68)   # 左侧树叶暖亮
LLEAF_D = (100, 130,  56)   # 左侧树叶暖暗
...
# 喷泉
FONT_S = (195, 218, 235)   # 喷泉冷蓝亮
FONT_D = (162, 188, 212)   # 喷泉冷蓝暗
FONT_M = (178, 202, 222)   # 喷泉冷蓝中
WATER  = ( 65, 228, 198)   # 水色
...
# 第一层水盆外缘 x=22~42
fl2(20, 21, 22, 42, FONT_S)
fl2(22, 23, 23, 41, FONT_S)
wrow2(19, 24, 40, FONT_S)
fl2(20, 23, 23, 41, FONT_S)
sp2(23, 20, FONT_D); sp2(27, 20, FONT_D); sp2(32, 20, FONT_D); sp2(37, 20, FONT_D); sp2(41, 20, FONT_D)
...
for _wy in [17, 18]:
    ...
    for _wx in range(FX-_w, FX+_w+1):
        if abs(_wx - FX) >= _w-1:
            sp2(_wx, _wy, SPRAY)
sp2(FX-2, 17, SPRAY); sp2(FX+2, 17, SPRAY)
sp2(FX-1, 16, SPRAY); sp2(FX, 16, SPRAY); sp2(FX+1, 16, SPRAY)
sp2(FX, 15, SPRAY)

# 底座 x=26~38
fl2(24, 25, 29, 35, FONT_D)
wrow2(24, 27, 37, FONT_S)

# 连接柱 x=29~35
fl2(25, 28, 28, 36, FONT_M)
wcol2(28, 25, 27, FONT_M)
wcol2(36, 25, 27, FONT_M)

# 第二层水盆 x=18~46
fl2(29, 30, 18, 46, FONT_S)
wrow2(31, 20, 44, FONT_S)
wcol2(16, 29, 30, FONT_S)
wcol2(16, 31, 31, FONT_S)
wcol2(17, 29, 31, FONT_S)
wcol2(47, 29, 31, FONT_S)
wcol2(48, 31, 31, FONT_S)
wcol2(48, 29, 30, FONT_S)
fl2(29, 29, 19, 45, WATER)
for _wx in [22, 18, 32, 46, 42]:
    sp2(_wx, 29, WATER_L)

# 第二层底座 x=22~42
fl2(31, 32, 22, 42, FONT_S)
wrow2(31, 23, 41, FONT_S)

for _wx in [23, 27, 32, 37, 41]:
    sp2(_wx, 19, WATER)
# 水流及盆面细节
sp2(18, 24, (65, 228, 198)); sp2(18, 25, (65, 228, 198)); sp2(18, 26, (65, 228, 198))
sp2(18, 27, (65, 228, 198)); sp2(18, 28, (65, 228, 198))
sp2(19, 22, (185, 245, 228)); sp2(19, 23, (65, 228, 198)); sp2(22, 28, (65, 228, 198))
sp2(20, 21, (185, 245, 228))
sp2(21, 20, (185, 245, 228))
sp2(22, 19, FONT_S); sp2(22, 20, (185, 245, 228)); sp2(22, 21, FONT_S)
sp2(22, 25, WATER); sp2(22, 26, WATER); sp2(22, 27, WATER); sp2(22, 28, (65, 228, 198)); sp2(42, 25, WATER); sp2(42, 26, WATER); sp2(42, 27, WATER); sp2(42, 28, (65, 228, 198))
sp2(23, 19, (65, 228, 198)); sp2(23, 21, FONT_S); sp2(23, 22, (185, 245, 228)); sp2(23, 23, (65, 228, 198)); sp2(23, 24, (65, 228, 198))
sp2(24, 21, (185, 245, 228)); sp2(24, 22, FONT_S)
sp2(25, 20, (185, 245, 228)); sp2(25, 21, FONT_S)
sp2(26, 20, (185, 245, 228))
sp2(27, 19, (65, 228, 198))
sp2(26, 24, FONT_S); sp2(38, 24, FONT_S)
sp2(41, 19, (65, 228, 198)); sp2(41, 21, FONT_S); sp2(41, 22, (185, 245, 228)); sp2(41, 23, (65, 228, 198)); sp2(41, 24, (65, 228, 198))
sp2(42, 19, FONT_S); sp2(42, 20, (185, 245, 228)); sp2(42, 21, FONT_S)
sp2(43, 20, (185, 245, 228))
sp2(44, 21, (185, 245, 228))
sp2(45, 22, (185, 245, 228)); sp2(45, 23, (65, 228, 198))
sp2(46, 24, (65, 228, 198)); sp2(46, 25, (65, 228, 198)); sp2(46, 26, (65, 228, 198)); sp2(46, 27, (65, 228, 198)); sp2(46, 28, (65, 228, 198))
sp2(39, 20, (185, 245, 228)); sp2(38, 20, (185, 245, 228))
sp2(40, 21, (185, 245, 228))
sp2(40, 22, FONT_S)
sp2(37, 19, (65, 228, 198))
sp2(32, 21, WATER_L); sp2(32, 22, WATER_L)
sp2(32, 23, WATER); sp2(32, 24, WATER); sp2(32, 25, WATER); sp2(32, 26, WATER); sp2(32, 27, WATER); sp2(32, 28, WATER)

# 喷泉底层
wrow2(31, 18, 46, FONT_S)
sp2(18, 31, FONT_S); sp2(46, 31, FONT_S)
