...
GROUND = (205, 185, 168)   # 地面（暖沙粉）
BENCH   = (132, 152, 178)   # 石椅冷蓝
BENCH_L = (148, 168, 195)   # 石椅亮冷蓝
BENCH_D = (112, 132, 158)   # 石椅暗冷蓝
LEAF    = ( 78, 138,  98)   # 大树叶主绿
LLEAF   = (102, 148, 145)   # 左侧树叶更冷绿
LLEAF_L = (118, 162, 158)   # 左侧树叶更冷绿亮
LLEAF_D = (88, 128, 125)    # 左侧树叶更冷绿暗
LEAF_L  = ( 92, 152, 112)   # 大树叶亮绿
LEAF_D  = ( 58, 112,  75)   # 大树叶暗绿
SHRUB   = (108, 158,  85)   # 灌木深绿
SHRUB_L = (135, 185, 108)   # 灌木亮绿
SHRUB_D = ( 72, 112,  58)   # 灌木暗绿
GROUND_D = (188, 168, 150)
...
# 喷泉
FONT_S = (118, 148, 172)   # 喷泉冷蓝亮
FONT_D = (78, 108, 138)   # 喷泉冷蓝暗
FONT_M = (98, 128, 155)   # 喷泉冷蓝中
WATER  = ( 65, 228, 198)   # 水色
...
sp(13, 30, SHRUB)  # 覆盖台阶色
sp(48, 30, SHRUB)  # 覆盖台阶色
sp(50, 30, SHRUB)
GCX, GCY = 9, 21
...
sp2(23, 21, FONT_S); sp2(27, 21, FONT_S); sp2(32, 21, WATER_L); sp2(37, 21, FONT_S); sp2(41, 21, FONT_S)
...
sp2(23, 20, FONT_D); sp2(23, 22, FONT_S); sp2(23, 23, (185, 245, 228)); sp2(23, 24, (65, 228, 198)); sp2(23, 25, (65, 228, 198))
...
sp2(41, 20, FONT_D); sp2(41, 22, FONT_S); sp2(41, 23, (185, 245, 228)); sp2(41, 24, (65, 228, 198)); sp2(41, 25, (65, 228, 198))
